            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('requisiciones.update', $requisicion->id) }}" method="POST">
                        ...
                        <!-- Número de Requisición, Unidad Responsable (UR), Departamento y Partida -->
                        <div class="row">
                        ...
                        <!-- Fecha de Entrega a Recursos Financieros, Fecha de Pago, Fecha de Requisición y Mes -->
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_requisicion" id="fecha_requisicion"
                                           ...
                                           value="{{ old('fecha_requisicion', optional($requisicion->fecha_requisicion)->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="mes" id="mes" class="form-control @error('mes') is-invalid @enderror">
                                        ...
                                        <option value="Enero" {{ old('mes', $requisicion->mes) == 'Enero' ? 'selected' : '' }}>Enero</option>
                                        <option value="Febrero" {{ old('mes', $requisicion->mes) == 'Febrero' ? 'selected' : '' }}>Febrero</option>
                                        <option value="Marzo" {{ old('mes', $requisicion->mes) == 'Marzo' ? 'selected' : '' }}>Marzo</option>
                                        <option value="Abril" {{ old('mes', $requisicion->mes) == 'Abril' ? 'selected' : '' }}>Abril</option>
                                        <option value="Mayo" {{ old('mes', $requisicion->mes) == 'Mayo' ? 'selected' : '' }}>Mayo</option>
                                        <option value="Junio" {{ old('mes', $requisicion->mes) == 'Junio' ? 'selected' : '' }}>Junio</option>
                                        <option value="Julio" {{ old('mes', $requisicion->mes) == 'Julio' ? 'selected' : '' }}>Julio</option>
                                        <option value="Agosto" {{ old('mes', $requisicion->mes) == 'Agosto' ? 'selected' : '' }}>Agosto</option>
                                        <option value="Septiembre" {{ old('mes', $requisicion->mes) == 'Septiembre' ? 'selected' : '' }}>Septiembre</option>
                                        <option value="Octubre" {{ old('mes', $requisicion->mes) == 'Octubre' ? 'selected' : '' }}>Octubre</option>
                                        <option value="Noviembre" {{ old('mes', $requisicion->mes) == 'Noviembre' ? 'selected' : '' }}>Noviembre</option>
                                        <option value="Diciembre" {{ old('mes', $requisicion->mes) == 'Diciembre' ? 'selected' : '' }}>Diciembre</option>
                                    </select>
                                    @error('mes')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        <!-- Producto o Material, Entrega a Recursos Financieros -->
                        <div class="row">
                        <!-- Producto o Material -->
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="turnado_a" id="turnado_a"
                                           ...
                                           value="{{ old('turnado_a', $requisicion->turnado_a) }}" placeholder="Ingresa dónde fue turnado">
                                    @error('turnado_a')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pago" id="pago"
                                           ...
                                           value="{{ old('pago', $requisicion->pago) }}" placeholder="Ingrese el pago">
                                    @error('pago')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="observaciones" id="observaciones"
                                              ...
                                              rows="4" placeholder="Ingrese observaciones">{{ old('observaciones', $requisicion->observaciones) }}</textarea>
                                    @error('observaciones')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="referencia" id="referencia"
                                              ...
                                              rows="2" placeholder="Ingrese la referencia">{{ old('referencia', $requisicion->referencia) }}</textarea>
                                    @error('referencia')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
