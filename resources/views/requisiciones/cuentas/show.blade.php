    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <div class="row">
                        {{-- Número de Requisición, Fecha y UR --}}
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        {{-- Departamento, Partida, Producto o Material --}}
                    ...
                    <div class="row">
                        {{-- Justificación, Proveedor y Monto --}}
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        {{-- Estado, Oficio de Pago y Número de Factura --}}
                    ...
                    <div class="row">
                        {{-- Fecha de Entrega a Recursos Financieros, Fecha de Pago y Banco --}}
                        <div class="col-md-4">
                            <div class="form-group">
