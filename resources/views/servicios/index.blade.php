...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            $('#servicios').DataTable({ // Cambiar el selector '#servicios' al id de la tabla.
                "dom": '<"row"<"col-sm-6"l><"col-sm-6"Bf>>rtip',
                "pageLength": 10,
                "lengthMenu": [[5, 10, 25, 50, -1], [5, 10, 25, 50, "Todos"]],
                "language": {
                    "emptyTable": "No hay información disponible",
                    "info": "Mostrando _START_ a _END_ de _TOTAL_ servicios",  // Mensaje de información.
                    "infoEmpty": "Mostrando 0 a 0 de 0 servicios",
                    "infoFiltered": "(filtrado de _MAX_ servicios en total)",  // Mensaje de información.
                    "lengthMenu": "Mostrar _MENU_ servicios",  // Mensaje de información.
