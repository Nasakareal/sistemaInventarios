...
@section('content_header')
    <h1>Editar Servicio de Mantenimiento</h1>
@stop
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="frecuencia_semanas" id="frecuencia_semanas"
                                           ...
                                           value="{{ old('frecuencia_semanas', $servicio->frecuencia_semanas) }}" min="1" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="ultima_realizacion" id="ultima_realizacion"
                                           ...
                                           value="{{ old('ultima_realizacion', $servicio->ultima_realizacion) }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" id="descripcion"
                                              ...
                                              rows="3" placeholder="Detalles adicionales">{{ old('descripcion', $servicio->descripcion) }}</textarea>
                                    @error('descripcion')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('js')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Cargar la fecha automáticamente si hay valores previos
            calcularProximaRealizacion();
        });
